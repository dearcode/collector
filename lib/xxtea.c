...
{
	char data[] = {
		"success@@1,2011-6-15 12:47:10,geilifa,,,此消息由核能QQ群群发发送！不用开启QQ客户端就可以群发消息的软件"
	};
	...
	char cbuf[10240] = { 0 };
	char dbuf[10240] = {
		"XgySOtjqMyOyYnetWV72Dch9kEYJbLhKcWfO0TOUeGxyN0yGJxaQtnwHhxO61LdmOCSV14z0Ey84BLaP8PvLP14+ssRqcLHFQfbo1hwlcpWlBNT/FgTUv9r30Whb4Vy8kytazIhfshHiu/MfftgvzSKnZwfUS/i6DAqk2sUDEMAlZoPCKubAKw=="
	};
